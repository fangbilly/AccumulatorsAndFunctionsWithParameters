...
def main():
    ...
    run_test_even_better_draw_circles(3, 5, rg.Point(200, 300), "red", 1)
...
def run_test_even_better_draw_circles(radii, number_of_circles, center_of_circles, outline_color_of_circles, speed):
    print()
    print('--------------------------------------------------')
    print('Testing  even_better_draw_circles:  See graphics window')
    print('--------------------------------------------------')
    even_better_draw_circles(radii, number_of_circles, center_of_circles, outline_color_of_circles, speed)


def even_better_draw_circles(radii, number_of_circles, center_of_circles, outline_color_of_circles, speed):
    window = rg.RoseWindow(400, 400)

    center = center_of_circles
    for k in range(number_of_circles):
        circle = rg.Circle(center, radii * k)
        circle.outline_color = outline_color_of_circles
        circle.attach_to(window)
